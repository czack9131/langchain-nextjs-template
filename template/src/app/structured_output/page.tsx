    ...
    <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden">
      ...
      <ul>
        ...
        <li>
          ☎️
          <span className="ml-2">
            The chain formats the input schema and passes it into an OpenAI Functions
            model, then parses the output.
          </span>
        </li>
        ...
        <li className="hidden text-l md:block">
          ...
          <span className="ml-2">
            ...
            <code>word_count</code>, <code>entity</code>, <code>chat_response</code>,
            and an optional <code>final_punctuation</code>, but you can change it to
            whatever you&apos;d like!
          </span>
        </li>
        <li className="hidden text-l md:block">
          ...
          <span className="ml-2">
            ...
            to define schemas, but you can initialize the chain with JSON schema too.
          </span>
        </li>
        <li className="hidden text-l md:block">
          🎨
